...
import br.com.locadora.acervo.AcervoDAO;
import br.com.locadora.cliente.ClienteDAO;
import br.com.locadora.dependente.DependenteDAO;
import br.com.locadora.servicoAcervo.ServicoAcervoDAO;
import br.com.locadora.servico.ServicoDAO;
import br.com.locadora.titulo.TituloDAO;
import br.com.locadora.acervo.Acervo;
import br.com.locadora.cliente.Cliente;
import br.com.locadora.dependente.Dependente;
import br.com.locadora.servico.Servico;
import br.com.locadora.servicoAcervo.ServicoAcervo;
import br.com.locadora.titulo.Titulo;
	...
	public void gravar(){
		try{
			if(clienteCadastrado == null || listaAcervoSelecionado.size() == 0){
				FacesUtil.addMsgErro("Imposs�vel efetuar loca��o! Pessoa n�o cadastrada na loja ou n�mero insuficiente de filmes selecionados!");
			}else{
				...
				listaAcervo.clear();
				FacesUtil.addMsgInfo("Loca��o efetuada com sucesso!");
			}
		}catch(RuntimeException ex){
		...
		public void carregarLista(){
			try{
				...
				FacesUtil.addMsgErro("Erro na listagem de Loca��es");
			}
		}
}
